...
- **mainnet**: `2023-03-03` to `2025-04-28`
- **holesky**: `2024-01-08` to `2025-04-28`
- **sepolia**: `2024-01-08` to `2025-04-28`
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/mempool_transaction/2025/4/23.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
2025-04-30 04:41:45 - Local table SQL DDL saved to ./schema/clickhouse/default/mempool_transaction_local.sql
2025-04-30 04:41:45 - Distributed table SQL DDL saved to ./schema/clickhouse/default/mempool_transaction.sql
<!-- schema_end -->

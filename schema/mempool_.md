...
- **mainnet**: `2023-03-03` to `2026-07-05`
- **holesky**: `2024-01-08` to `2025-10-26`
- **sepolia**: `2024-01-08` to `2026-07-05`
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/mempool_transaction/2026/7/5.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```

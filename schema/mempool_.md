...
- **mainnet**: `2023-07-22` to `2024-09-21`
- **holesky**: `2024-01-08` to `2024-09-21`
- **sepolia**: `2024-01-08` to `2024-09-21`
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query \
 "SELECT * \
 FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/mempool_transaction/2024/9/15.parquet', 'Parquet') \
 LIMIT 10"
```

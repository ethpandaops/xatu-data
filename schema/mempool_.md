...
- **mainnet**: `2023-03-03` to `2025-09-07`
- **holesky**: `2024-01-08` to `2025-09-07`
- **sepolia**: `2024-01-08` to `2025-09-07`
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/mempool_transaction/2025/9/7.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```

...
- **mainnet**: `2023-03-03` to `2025-05-03`
- **holesky**: `2024-01-08` to `2025-05-03`
- **sepolia**: `2024-01-08` to `2025-05-03`
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/mempool_transaction/2025/4/27.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
2025-05-04 18:03:47 - Local table SQL DDL saved to ./schema/clickhouse/default/mempool_transaction_local.sql
2025-05-04 18:03:47 - Distributed table SQL DDL saved to ./schema/clickhouse/default/mempool_transaction.sql
<!-- schema_end -->

...
- **sepolia**: `2022-06-25` to `2025-09-01`
...
- **mainnet**: `2023-06-01` to `2025-09-01`
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v1_events_attestation/2025/9/1/0.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```

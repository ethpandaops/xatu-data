...
- **mainnet**: `2023-09-04` to `2026-04-01`
- **holesky**: `2023-09-28` to `2025-10-26`
- **sepolia**: `2022-06-25` to `2026-04-01`
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v1_beacon_committee/2026/4/1/0.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
- **mainnet**: `2023-06-01` to `2026-04-01`
- **holesky**: `2023-09-18` to `2025-11-17`
- **sepolia**: `2023-08-31` to `2026-04-01`
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v1_events_attestation/2026/4/1/0.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
- **holesky**: `2020-12-02` to `2026-04-01`
- **sepolia**: `2023-12-24` to `2026-04-01`
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v1_events_block/2026/4/1.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
- **mainnet**: `2025-05-14` to `2026-04-01`
- **holesky**: `2025-05-14` to `2025-11-22`
- **sepolia**: `2025-05-14` to `2026-04-01`
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v1_events_block_gossip/2026/4/1.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
- **mainnet**: `2023-03-01` to `2026-04-01`
- **holesky**: `2024-02-05` to `2026-04-01`
- **sepolia**: `2023-12-30` to `2026-04-01`
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v1_events_chain_reorg/2026/4/1.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
- **mainnet**: `2023-08-31` to `2026-04-01`
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v1_events_contribution_and_proof/2026/4/1.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v1_events_data_column_sidecar/2026/4/1.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
- **mainnet**: `2020-12-01` to `2026-04-01`
- **holesky**: `2023-03-26` to `2026-04-01`
- **sepolia**: `2023-03-26` to `2026-04-01`
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v1_events_finalized_checkpoint/2026/4/1.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
- **mainnet**: `2020-12-01` to `2026-04-01`
- **holesky**: `2023-12-05` to `2026-04-01`
- **sepolia**: `2023-12-05` to `2026-04-01`
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v1_events_head/2026/4/1.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v1_events_voluntary_exit/2026/4/1.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v1_validator_attestation_data/2026/4/1.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
- **mainnet**: `2020-12-01` to `2026-04-01`
- **holesky**: `2023-09-28` to `2025-10-26`
- **sepolia**: `2022-06-20` to `2026-04-01`
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v2_beacon_block/2026/4/1.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
- **mainnet**: `2024-04-03` to `2026-04-01`
- **holesky**: `2024-04-03` to `2025-10-26`
- **sepolia**: `2024-04-03` to `2026-04-01`
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v1_proposer_duty/2026/4/1.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
- **mainnet**: `2024-11-25` to `2026-04-01`
- **holesky**: `2024-11-25` to `2025-10-26`
- **sepolia**: `2024-11-25` to `2026-04-01`
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v3_validator_block/2026/4/1.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```

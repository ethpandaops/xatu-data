...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v1_beacon_committee/2025/5/21/0.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
2025-05-28 18:03:30 - Local table SQL DDL saved to ./schema/clickhouse/default/beacon_api_eth_v1_beacon_committee_local.sql
2025-05-28 18:03:30 - Distributed table SQL DDL saved to ./schema/clickhouse/default/beacon_api_eth_v1_beacon_committee.sql
...
- **sepolia**: `2023-08-31` to `2025-05-26`
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v1_events_attestation/2025/5/21/0.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
2025-05-28 18:03:30 - Local table SQL DDL saved to ./schema/clickhouse/default/beacon_api_eth_v1_events_attestation_local.sql
2025-05-28 18:03:30 - Distributed table SQL DDL saved to ./schema/clickhouse/default/beacon_api_eth_v1_events_attestation.sql
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v1_events_blob_sidecar/2025/5/21.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
2025-05-28 18:03:30 - Local table SQL DDL saved to ./schema/clickhouse/default/beacon_api_eth_v1_events_blob_sidecar_local.sql
2025-05-28 18:03:30 - Distributed table SQL DDL saved to ./schema/clickhouse/default/beacon_api_eth_v1_events_blob_sidecar.sql
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v1_events_block/2025/5/21.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
2025-05-28 18:03:30 - Local table SQL DDL saved to ./schema/clickhouse/default/beacon_api_eth_v1_events_block_local.sql
2025-05-28 18:03:30 - Distributed table SQL DDL saved to ./schema/clickhouse/default/beacon_api_eth_v1_events_block.sql
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v1_events_chain_reorg/2025/5/21.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
2025-05-28 18:03:30 - Local table SQL DDL saved to ./schema/clickhouse/default/beacon_api_eth_v1_events_chain_reorg_local.sql
2025-05-28 18:03:30 - Distributed table SQL DDL saved to ./schema/clickhouse/default/beacon_api_eth_v1_events_chain_reorg.sql
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v1_events_contribution_and_proof/2025/5/21.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
2025-05-28 18:03:30 - Local table SQL DDL saved to ./schema/clickhouse/default/beacon_api_eth_v1_events_contribution_and_proof_local.sql
2025-05-28 18:03:30 - Distributed table SQL DDL saved to ./schema/clickhouse/default/beacon_api_eth_v1_events_contribution_and_proof.sql
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v1_events_finalized_checkpoint/2025/5/21.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
2025-05-28 18:03:30 - Local table SQL DDL saved to ./schema/clickhouse/default/beacon_api_eth_v1_events_finalized_checkpoint_local.sql
2025-05-28 18:03:30 - Distributed table SQL DDL saved to ./schema/clickhouse/default/beacon_api_eth_v1_events_finalized_checkpoint.sql
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v1_events_head/2025/5/21.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
2025-05-28 18:03:30 - Local table SQL DDL saved to ./schema/clickhouse/default/beacon_api_eth_v1_events_head_local.sql
2025-05-28 18:03:30 - Distributed table SQL DDL saved to ./schema/clickhouse/default/beacon_api_eth_v1_events_head.sql
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v1_events_voluntary_exit/2025/5/21.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
2025-05-28 18:03:31 - Local table SQL DDL saved to ./schema/clickhouse/default/beacon_api_eth_v1_events_voluntary_exit_local.sql
2025-05-28 18:03:31 - Distributed table SQL DDL saved to ./schema/clickhouse/default/beacon_api_eth_v1_events_voluntary_exit.sql
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v1_validator_attestation_data/2025/5/21.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
2025-05-28 18:03:31 - Local table SQL DDL saved to ./schema/clickhouse/default/beacon_api_eth_v1_validator_attestation_data_local.sql
2025-05-28 18:03:31 - Distributed table SQL DDL saved to ./schema/clickhouse/default/beacon_api_eth_v1_validator_attestation_data.sql
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v2_beacon_block/2025/5/21.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
2025-05-28 18:03:31 - Local table SQL DDL saved to ./schema/clickhouse/default/beacon_api_eth_v2_beacon_block_local.sql
2025-05-28 18:03:31 - Distributed table SQL DDL saved to ./schema/clickhouse/default/beacon_api_eth_v2_beacon_block.sql
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v1_proposer_duty/2025/5/21.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
2025-05-28 18:03:31 - Local table SQL DDL saved to ./schema/clickhouse/default/beacon_api_eth_v1_proposer_duty_local.sql
2025-05-28 18:03:31 - Distributed table SQL DDL saved to ./schema/clickhouse/default/beacon_api_eth_v1_proposer_duty.sql
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v3_validator_block/2025/5/21.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
2025-05-28 18:03:31 - Local table SQL DDL saved to ./schema/clickhouse/default/beacon_api_eth_v3_validator_block_local.sql
2025-05-28 18:03:31 - Distributed table SQL DDL saved to ./schema/clickhouse/default/beacon_api_eth_v3_validator_block.sql
<!-- schema_end -->

...
- **sepolia**: `2022-06-25` to `2026-01-17`
...
- **mainnet**: `2023-06-01` to `2026-01-17`
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v1_events_attestation/2026/1/17/0.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```

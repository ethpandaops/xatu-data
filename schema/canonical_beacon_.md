...
- **holesky**: `2023-09-23` to `2025-04-30`
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/canonical_beacon_block/2025/4/24.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
2025-05-01 18:04:22 - Local table SQL DDL saved to ./schema/clickhouse/default/canonical_beacon_block_local.sql
2025-05-01 18:04:22 - Distributed table SQL DDL saved to ./schema/clickhouse/default/canonical_beacon_block.sql
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/canonical_beacon_committee/2025/4/24.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
2025-05-01 18:04:22 - Local table SQL DDL saved to ./schema/clickhouse/default/canonical_beacon_committee_local.sql
2025-05-01 18:04:22 - Distributed table SQL DDL saved to ./schema/clickhouse/default/canonical_beacon_committee.sql
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/canonical_beacon_block_attester_slashing/2025/4/24.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
2025-05-01 18:04:22 - Local table SQL DDL saved to ./schema/clickhouse/default/canonical_beacon_block_attester_slashing_local.sql
2025-05-01 18:04:22 - Distributed table SQL DDL saved to ./schema/clickhouse/default/canonical_beacon_block_attester_slashing.sql
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/canonical_beacon_block_proposer_slashing/2025/4/24.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
2025-05-01 18:04:22 - Local table SQL DDL saved to ./schema/clickhouse/default/canonical_beacon_block_proposer_slashing_local.sql
2025-05-01 18:04:22 - Distributed table SQL DDL saved to ./schema/clickhouse/default/canonical_beacon_block_proposer_slashing.sql
...
- **mainnet**: `2023-04-12` to `2025-04-30`
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/canonical_beacon_block_bls_to_execution_change/2025/4/24.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
2025-05-01 18:04:22 - Local table SQL DDL saved to ./schema/clickhouse/default/canonical_beacon_block_bls_to_execution_change_local.sql
2025-05-01 18:04:22 - Distributed table SQL DDL saved to ./schema/clickhouse/default/canonical_beacon_block_bls_to_execution_change.sql
...
- **mainnet**: `2022-09-06` to `2025-04-30`
- **holesky**: `2023-09-23` to `2025-04-30`
- **sepolia**: `2022-06-22` to `2025-04-30`
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/canonical_beacon_block_execution_transaction/2025/4/24.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
2025-05-01 18:04:22 - Local table SQL DDL saved to ./schema/clickhouse/default/canonical_beacon_block_execution_transaction_local.sql
2025-05-01 18:04:22 - Distributed table SQL DDL saved to ./schema/clickhouse/default/canonical_beacon_block_execution_transaction.sql
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/canonical_beacon_block_voluntary_exit/2025/4/24.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
2025-05-01 18:04:22 - Local table SQL DDL saved to ./schema/clickhouse/default/canonical_beacon_block_voluntary_exit_local.sql
2025-05-01 18:04:22 - Distributed table SQL DDL saved to ./schema/clickhouse/default/canonical_beacon_block_voluntary_exit.sql
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/canonical_beacon_block_deposit/2025/4/24.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
2025-05-01 18:04:23 - Local table SQL DDL saved to ./schema/clickhouse/default/canonical_beacon_block_deposit_local.sql
2025-05-01 18:04:23 - Distributed table SQL DDL saved to ./schema/clickhouse/default/canonical_beacon_block_deposit.sql
...
- **mainnet**: `2023-04-12` to `2025-04-30`
- **holesky**: `2023-09-23` to `2025-04-30`
- **sepolia**: `2023-02-28` to `2025-04-30`
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/canonical_beacon_block_withdrawal/2025/4/24.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
2025-05-01 18:04:23 - Local table SQL DDL saved to ./schema/clickhouse/default/canonical_beacon_block_withdrawal_local.sql
2025-05-01 18:04:23 - Distributed table SQL DDL saved to ./schema/clickhouse/default/canonical_beacon_block_withdrawal.sql
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/canonical_beacon_blob_sidecar/2025/4/24.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
2025-05-01 18:04:23 - Local table SQL DDL saved to ./schema/clickhouse/default/canonical_beacon_blob_sidecar_local.sql
2025-05-01 18:04:23 - Distributed table SQL DDL saved to ./schema/clickhouse/default/canonical_beacon_blob_sidecar.sql
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/canonical_beacon_proposer_duty/2025/4/24.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
2025-05-01 18:04:23 - Local table SQL DDL saved to ./schema/clickhouse/default/canonical_beacon_proposer_duty_local.sql
2025-05-01 18:04:23 - Distributed table SQL DDL saved to ./schema/clickhouse/default/canonical_beacon_proposer_duty.sql
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/canonical_beacon_elaborated_attestation/2025/4/24.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
2025-05-01 18:04:23 - Local table SQL DDL saved to ./schema/clickhouse/default/canonical_beacon_elaborated_attestation_local.sql
2025-05-01 18:04:23 - Distributed table SQL DDL saved to ./schema/clickhouse/default/canonical_beacon_elaborated_attestation.sql
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/canonical_beacon_validators/2025/4/24/0.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
2025-05-01 18:04:23 - Local table SQL DDL saved to ./schema/clickhouse/default/canonical_beacon_validators_local.sql
2025-05-01 18:04:23 - Distributed table SQL DDL saved to ./schema/clickhouse/default/canonical_beacon_validators.sql
...
2025-05-01 18:04:23 - Local table SQL DDL saved to ./schema/clickhouse/default/canonical_beacon_validators_pubkeys_local.sql
2025-05-01 18:04:23 - Distributed table SQL DDL saved to ./schema/clickhouse/default/canonical_beacon_validators_pubkeys.sql
<!-- schema_end -->

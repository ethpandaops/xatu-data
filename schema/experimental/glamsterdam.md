...
**Glamsterdam** is an upcoming Ethereum network upgrade; `gloas` is its consensus-layer fork. Xatu collects data from Glamsterdam devnets using its [`release/gloas`](https://github.com/ethpandaops/xatu/tree/release/gloas) branch.

## Active devnets

| Network | Fork-specific tables | Explorer | Source |
|---------|----------------------|----------|--------|
| `bal-devnet-7` | 0 | [Dora](https://dora.bal-devnet-7.ethpandaops.io) | [ethpandaops/bal-devnets](https://github.com/ethpandaops/bal-devnets) |
| `glamsterdam-devnet-6` | 16 | [Dora](https://dora.glamsterdam-devnet-6.ethpandaops.io) | [ethpandaops/glamsterdam-devnets](https://github.com/ethpandaops/glamsterdam-devnets) |
...
```sql
SELECT * FROM `bal-devnet-7`.beacon_api_eth_v1_events_block LIMIT 3
```

...
- **mainnet**: `2024-05-01` to `2025-05-19`
- **holesky**: `2024-05-01` to `2025-05-12`
- **sepolia**: `2024-05-01` to `2025-05-19`
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/libp2p_gossipsub_beacon_attestation/2025/5/13/0.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
2025-05-20 18:03:54 - Local table SQL DDL saved to ./schema/clickhouse/default/libp2p_gossipsub_beacon_attestation_local.sql
2025-05-20 18:03:54 - Distributed table SQL DDL saved to ./schema/clickhouse/default/libp2p_gossipsub_beacon_attestation.sql
...
- **holesky**: `2024-04-26` to `2025-05-12`
- **sepolia**: `2024-04-26` to `2025-05-19`
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/libp2p_gossipsub_beacon_block/2025/5/13.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
2025-05-20 18:03:54 - Local table SQL DDL saved to ./schema/clickhouse/default/libp2p_gossipsub_beacon_block_local.sql
2025-05-20 18:03:54 - Distributed table SQL DDL saved to ./schema/clickhouse/default/libp2p_gossipsub_beacon_block.sql
...
- **mainnet**: `2020-12-01` to `2025-05-19`
- **holesky**: `2024-06-03` to `2025-05-12`
- **sepolia**: `2024-06-03` to `2025-05-19`
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/libp2p_gossipsub_blob_sidecar/2025/5/13.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
2025-05-20 18:03:54 - Local table SQL DDL saved to ./schema/clickhouse/default/libp2p_gossipsub_blob_sidecar_local.sql
2025-05-20 18:03:54 - Distributed table SQL DDL saved to ./schema/clickhouse/default/libp2p_gossipsub_blob_sidecar.sql
<!-- schema_end -->

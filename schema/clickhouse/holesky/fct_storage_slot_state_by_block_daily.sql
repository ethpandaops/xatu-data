CREATE TABLE holesky.fct_storage_slot_state_by_block_daily
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'fct_storage_slot_state_by_block_daily_local', cityHash64(day_start_date))

CREATE TABLE holesky.fct_block_first_seen_by_node_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/mainnet/fct_block_first_seen_by_node_local', '{replica}', updated_date_time)

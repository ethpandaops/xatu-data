CREATE TABLE holesky.fct_engine_new_payload_winrate_hourly
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'fct_engine_new_payload_winrate_hourly_local', cityHash64(hour_start_date_time, node_class))

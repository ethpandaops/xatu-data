CREATE TABLE holesky.fct_storage_slot_state_with_expiry_by_block_daily_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/mainnet/fct_storage_slot_state_with_expiry_by_block_daily_local', '{replica}', updated_date_time)

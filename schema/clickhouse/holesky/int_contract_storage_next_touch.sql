CREATE TABLE holesky.int_contract_storage_next_touch
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'int_contract_storage_next_touch_local', cityHash64(block_number, address))

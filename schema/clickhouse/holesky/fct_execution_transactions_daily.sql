CREATE TABLE holesky.fct_execution_transactions_daily
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'fct_execution_transactions_daily_local', cityHash64(day_start_date))

CREATE TABLE holesky.fct_attestation_participation_rate_hourly
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'fct_attestation_participation_rate_hourly_local', cityHash64(hour_start_date_time))

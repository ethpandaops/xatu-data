CREATE TABLE holesky.fct_execution_gas_limit_hourly
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'fct_execution_gas_limit_hourly_local', cityHash64(hour_start_date_time))

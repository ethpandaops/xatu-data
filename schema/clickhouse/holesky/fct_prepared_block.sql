CREATE TABLE holesky.fct_prepared_block
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'fct_prepared_block_local', cityHash64(slot_start_date_time, slot, meta_client_name))

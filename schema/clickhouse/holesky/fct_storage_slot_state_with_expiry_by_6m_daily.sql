CREATE TABLE holesky.fct_storage_slot_state_with_expiry_by_6m_daily
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'fct_storage_slot_state_with_expiry_by_6m_daily_local', cityHash64(day_start_date))

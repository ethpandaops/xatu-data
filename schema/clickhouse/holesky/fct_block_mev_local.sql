CREATE TABLE holesky.fct_block_mev_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/mainnet/fct_block_mev_local', '{replica}', updated_date_time)

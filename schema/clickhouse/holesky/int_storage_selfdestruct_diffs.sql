CREATE TABLE holesky.int_storage_selfdestruct_diffs
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'int_storage_selfdestruct_diffs_local', cityHash64(block_number, address))

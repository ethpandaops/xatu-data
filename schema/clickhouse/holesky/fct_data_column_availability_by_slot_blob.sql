CREATE TABLE holesky.fct_data_column_availability_by_slot_blob
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'fct_data_column_availability_by_slot_blob_local', cityHash64(slot_start_date_time, blob_index, column_index))

CREATE TABLE holesky.fct_attestation_vote_correctness_by_validator_local
(
    ...
    PROJECTION p_by_slot_start_date_time
    (
        SELECT *
        ORDER BY
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/mainnet/fct_attestation_vote_correctness_by_validator_local', '{replica}', updated_date_time)

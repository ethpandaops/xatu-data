CREATE TABLE holesky.fct_attestation_inclusion_delay_daily
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'fct_attestation_inclusion_delay_daily_local', cityHash64(day_start_date))

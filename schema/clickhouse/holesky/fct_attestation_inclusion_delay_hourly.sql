CREATE TABLE holesky.fct_attestation_inclusion_delay_hourly
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'fct_attestation_inclusion_delay_hourly_local', cityHash64(hour_start_date_time))

CREATE TABLE holesky.int_attestation_first_seen
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'int_attestation_first_seen_local', cityHash64(slot_start_date_time, attesting_validator_index))

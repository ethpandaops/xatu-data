CREATE TABLE holesky.fct_blob_count_daily_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/mainnet/fct_blob_count_daily_local', '{replica}', updated_date_time)

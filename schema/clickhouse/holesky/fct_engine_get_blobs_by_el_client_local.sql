CREATE TABLE holesky.fct_engine_get_blobs_by_el_client_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/mainnet/fct_engine_get_blobs_by_el_client_local', '{replica}', updated_date_time)

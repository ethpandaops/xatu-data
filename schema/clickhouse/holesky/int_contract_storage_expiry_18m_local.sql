CREATE TABLE holesky.int_contract_storage_expiry_18m_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/mainnet/int_contract_storage_expiry_18m_local', '{replica}', updated_date_time)

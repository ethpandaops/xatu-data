CREATE TABLE holesky.fct_data_column_availability_hourly
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'fct_data_column_availability_hourly_local', cityHash64(hour_start_date_time, column_index))

CREATE TABLE holesky.fct_execution_receipt_size_hourly_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/mainnet/fct_execution_receipt_size_hourly_local', '{replica}', updated_date_time)

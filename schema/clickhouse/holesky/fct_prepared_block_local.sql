CREATE TABLE holesky.fct_prepared_block_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/mainnet/fct_prepared_block_local', '{replica}', updated_date_time)

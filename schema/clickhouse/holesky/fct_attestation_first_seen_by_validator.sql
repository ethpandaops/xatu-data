CREATE TABLE holesky.fct_attestation_first_seen_by_validator
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'fct_attestation_first_seen_by_validator_local', cityHash64(slot_start_date_time, validator_index))

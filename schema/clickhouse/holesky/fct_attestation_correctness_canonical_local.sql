CREATE TABLE holesky.fct_attestation_correctness_canonical_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/mainnet/fct_attestation_correctness_canonical_local', '{replica}', updated_date_time)

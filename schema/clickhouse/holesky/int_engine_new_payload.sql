CREATE TABLE holesky.int_engine_new_payload
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'int_engine_new_payload_local', cityHash64(slot_start_date_time, block_hash, meta_client_name, event_date_time))

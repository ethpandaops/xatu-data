CREATE TABLE holesky.fct_token_contract_storage_state_by_block_daily
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'fct_token_contract_storage_state_by_block_daily_local', cityHash64(day_start_date))

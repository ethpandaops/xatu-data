CREATE TABLE holesky.int_transaction_call_frame_opcode_resource_gas
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'int_transaction_call_frame_opcode_resource_gas_local', cityHash64(block_number, transaction_hash))

CREATE TABLE holesky.fct_address_storage_slot_expired_top_100_by_contract
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'fct_address_storage_slot_expired_top_100_by_contract_local', cityHash64(contract_address))

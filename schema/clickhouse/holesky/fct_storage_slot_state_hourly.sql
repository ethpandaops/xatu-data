CREATE TABLE holesky.fct_storage_slot_state_hourly
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'fct_storage_slot_state_hourly_local', cityHash64(hour_start_date_time))

CREATE TABLE holesky.dim_block_blob_submitter
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'dim_block_blob_submitter_local', cityHash64(block_number, transaction_index))

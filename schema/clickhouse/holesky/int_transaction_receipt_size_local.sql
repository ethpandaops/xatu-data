CREATE TABLE holesky.int_transaction_receipt_size_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/mainnet/int_transaction_receipt_size_local', '{replica}', updated_date_time)

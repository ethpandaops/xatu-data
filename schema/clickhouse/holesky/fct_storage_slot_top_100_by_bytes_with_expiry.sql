CREATE TABLE holesky.fct_storage_slot_top_100_by_bytes_with_expiry
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'fct_storage_slot_top_100_by_bytes_with_expiry_local', cityHash64(expiry_policy, rank))

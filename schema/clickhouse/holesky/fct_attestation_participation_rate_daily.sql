CREATE TABLE holesky.fct_attestation_participation_rate_daily
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'fct_attestation_participation_rate_daily_local', cityHash64(day_start_date))

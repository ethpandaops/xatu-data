CREATE TABLE holesky.int_beacon_committee
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'int_beacon_committee_local', cityHash64(slot_start_date_time, committee_index))

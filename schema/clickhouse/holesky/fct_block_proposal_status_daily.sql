CREATE TABLE holesky.fct_block_proposal_status_daily
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'fct_block_proposal_status_daily_local', cityHash64(day_start_date))

CREATE TABLE holesky.fct_attestation_liveness_by_entity_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/mainnet/fct_attestation_liveness_by_entity_local', '{replica}', updated_date_time)

CREATE TABLE holesky.fct_head_vote_correctness_rate_hourly_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/mainnet/fct_head_vote_correctness_rate_hourly_local', '{replica}', updated_date_time)

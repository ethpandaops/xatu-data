CREATE TABLE holesky.helper_contract_storage_next_touch_latest_state
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'helper_contract_storage_next_touch_latest_state_local', cityHash64(address))

CREATE TABLE holesky.fct_storage_slot_top_100_by_bytes_with_expiry_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/mainnet/fct_storage_slot_top_100_by_bytes_with_expiry_local', '{replica}', updated_date_time)
PARTITION BY tuple()

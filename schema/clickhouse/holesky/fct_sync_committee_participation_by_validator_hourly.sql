CREATE TABLE holesky.fct_sync_committee_participation_by_validator_hourly
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'fct_sync_committee_participation_by_validator_hourly_local', cityHash64(validator_index, hour_start_date_time))

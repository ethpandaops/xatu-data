CREATE TABLE holesky.int_storage_slot_diff_by_address_slot
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'int_storage_slot_diff_by_address_slot_local', cityHash64(address, slot_key))

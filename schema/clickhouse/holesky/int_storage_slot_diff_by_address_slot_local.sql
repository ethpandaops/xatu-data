CREATE TABLE holesky.int_storage_slot_diff_by_address_slot_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/mainnet/int_storage_slot_diff_by_address_slot_local', '{replica}', updated_date_time)

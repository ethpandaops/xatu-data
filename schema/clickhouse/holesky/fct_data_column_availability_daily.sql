CREATE TABLE holesky.fct_data_column_availability_daily
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'fct_data_column_availability_daily_local', cityHash64(date, column_index))

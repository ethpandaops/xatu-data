CREATE TABLE holesky.fct_opcode_gas_by_opcode_hourly
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'fct_opcode_gas_by_opcode_hourly_local', cityHash64(hour_start_date_time))

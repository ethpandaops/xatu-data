CREATE TABLE holesky.int_storage_slot_reactivation_6m
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'int_storage_slot_reactivation_6m_local', cityHash64(block_number, address))

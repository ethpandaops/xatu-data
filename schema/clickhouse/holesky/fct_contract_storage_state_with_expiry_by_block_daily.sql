CREATE TABLE holesky.fct_contract_storage_state_with_expiry_by_block_daily
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'fct_contract_storage_state_with_expiry_by_block_daily_local', cityHash64(expiry_policy, day_start_date))

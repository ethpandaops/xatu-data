CREATE TABLE holesky.int_storage_slot_state_with_expiry_by_block
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'int_storage_slot_state_with_expiry_by_block_local', cityHash64(block_number))

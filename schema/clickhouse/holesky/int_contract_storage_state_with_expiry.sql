CREATE TABLE holesky.int_contract_storage_state_with_expiry
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'int_contract_storage_state_with_expiry_local', cityHash64(block_number, address))

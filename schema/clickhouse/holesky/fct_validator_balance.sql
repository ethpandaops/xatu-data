CREATE TABLE holesky.fct_validator_balance
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'fct_validator_balance_local', cityHash64(validator_index, epoch_start_date_time))

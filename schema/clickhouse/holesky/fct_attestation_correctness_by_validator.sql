CREATE TABLE holesky.fct_attestation_correctness_by_validator
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'fct_attestation_correctness_by_validator_local', cityHash64(slot_start_date_time, attesting_validator_index))

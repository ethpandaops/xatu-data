CREATE TABLE holesky.fct_storage_slot_state_with_expiry_hourly
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'fct_storage_slot_state_with_expiry_hourly_local', cityHash64(expiry_policy, hour_start_date_time))

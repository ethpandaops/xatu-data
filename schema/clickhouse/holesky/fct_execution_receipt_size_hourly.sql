CREATE TABLE holesky.fct_execution_receipt_size_hourly
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'fct_execution_receipt_size_hourly_local', cityHash64(hour_start_date_time))

CREATE TABLE holesky.int_contract_storage_expiry_12m
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'int_contract_storage_expiry_12m_local', cityHash64(block_number, address))

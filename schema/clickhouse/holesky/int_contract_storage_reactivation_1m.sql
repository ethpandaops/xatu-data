CREATE TABLE holesky.int_contract_storage_reactivation_1m
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'int_contract_storage_reactivation_1m_local', cityHash64(block_number, address))

CREATE TABLE holesky.fct_block_first_seen_by_node
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'fct_block_first_seen_by_node_local', cityHash64(slot_start_date_time, meta_client_name))

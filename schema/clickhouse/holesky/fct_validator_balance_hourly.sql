CREATE TABLE holesky.fct_validator_balance_hourly
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'fct_validator_balance_hourly_local', cityHash64(validator_index, hour_start_date_time))

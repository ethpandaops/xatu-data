CREATE TABLE holesky.int_contract_storage_state_by_block
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'int_contract_storage_state_by_block_local', cityHash64(block_number))

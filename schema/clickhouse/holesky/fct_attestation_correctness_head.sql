CREATE TABLE holesky.fct_attestation_correctness_head
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'fct_attestation_correctness_head_local', cityHash64(slot_start_date_time))

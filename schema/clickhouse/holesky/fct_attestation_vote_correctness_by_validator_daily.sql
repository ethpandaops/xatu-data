CREATE TABLE holesky.fct_attestation_vote_correctness_by_validator_daily
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'fct_attestation_vote_correctness_by_validator_daily_local', cityHash64(validator_index, day_start_date))

CREATE TABLE holesky.fct_block_data_column_sidecar_first_seen
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'fct_block_data_column_sidecar_first_seen_local', cityHash64(slot_start_date_time, block_root))

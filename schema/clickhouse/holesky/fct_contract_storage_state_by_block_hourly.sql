CREATE TABLE holesky.fct_contract_storage_state_by_block_hourly
(
...
ENGINE = Distributed('{cluster}', 'holesky', 'fct_contract_storage_state_by_block_hourly_local', cityHash64(hour_start_date_time))

CREATE TABLE sepolia.fct_attestation_vote_correctness_by_validator_hourly
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'fct_attestation_vote_correctness_by_validator_hourly_local', cityHash64(validator_index, hour_start_date_time))

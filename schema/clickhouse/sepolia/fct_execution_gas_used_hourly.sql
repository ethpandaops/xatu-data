CREATE TABLE sepolia.fct_execution_gas_used_hourly
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'fct_execution_gas_used_hourly_local', cityHash64(hour_start_date_time))

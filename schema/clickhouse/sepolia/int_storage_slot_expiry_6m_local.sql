CREATE TABLE sepolia.int_storage_slot_expiry_6m_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/mainnet/int_storage_slot_expiry_6m_local', '{replica}', updated_date_time)

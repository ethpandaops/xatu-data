CREATE TABLE sepolia.int_storage_slot_reactivation_24m
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'int_storage_slot_reactivation_24m_local', cityHash64(block_number, address))

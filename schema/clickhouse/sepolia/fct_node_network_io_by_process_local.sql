CREATE TABLE sepolia.fct_node_network_io_by_process_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/mainnet/fct_node_network_io_by_process_local', '{replica}', updated_date_time)
PARTITION BY toStartOfMonth(wallclock_slot_start_date_time)
ORDER BY (wallclock_slot_start_date_time, meta_client_name, client_type, pid, port_label, direction, window_start)

CREATE TABLE sepolia.fct_node_network_io_by_process
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'fct_node_network_io_by_process_local', cityHash64(wallclock_slot_start_date_time, meta_client_name))

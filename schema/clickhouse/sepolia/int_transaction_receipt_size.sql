CREATE TABLE sepolia.int_transaction_receipt_size
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'int_transaction_receipt_size_local', cityHash64(block_number, transaction_hash))

CREATE TABLE sepolia.fct_execution_transactions_hourly_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/mainnet/fct_execution_transactions_hourly_local', '{replica}', updated_date_time)

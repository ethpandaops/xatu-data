CREATE TABLE sepolia.int_attestation_attested_canonical
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'int_attestation_attested_canonical_local', cityHash64(slot_start_date_time, block_root, attesting_validator_index))

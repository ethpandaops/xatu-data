CREATE TABLE sepolia.fct_contract_storage_state_by_address_hourly
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'fct_contract_storage_state_by_address_hourly_local', cityHash64(address, hour_start_date_time))

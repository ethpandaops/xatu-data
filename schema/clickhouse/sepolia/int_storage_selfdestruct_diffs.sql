CREATE TABLE sepolia.int_storage_selfdestruct_diffs
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'int_storage_selfdestruct_diffs_local', cityHash64(block_number, address))

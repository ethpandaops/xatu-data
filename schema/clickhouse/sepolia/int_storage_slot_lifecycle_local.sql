CREATE TABLE sepolia.int_storage_slot_lifecycle_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/mainnet/int_storage_slot_lifecycle_local', '{replica}', updated_date_time)

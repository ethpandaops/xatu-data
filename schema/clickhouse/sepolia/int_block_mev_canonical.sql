CREATE TABLE sepolia.int_block_mev_canonical
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'int_block_mev_canonical_local', cityHash64(slot_start_date_time, block_root))

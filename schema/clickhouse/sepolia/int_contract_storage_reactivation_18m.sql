CREATE TABLE sepolia.int_contract_storage_reactivation_18m
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'int_contract_storage_reactivation_18m_local', cityHash64(block_number, address))

CREATE TABLE sepolia.fct_attestation_inclusion_delay_hourly
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'fct_attestation_inclusion_delay_hourly_local', cityHash64(hour_start_date_time))

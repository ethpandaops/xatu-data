CREATE TABLE sepolia.int_contract_storage_expiry_6m_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/mainnet/int_contract_storage_expiry_6m_local', '{replica}', updated_date_time)

CREATE TABLE sepolia.fct_address_storage_slot_top_100_by_contract
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'fct_address_storage_slot_top_100_by_contract_local', cityHash64(contract_address))

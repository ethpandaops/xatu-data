CREATE TABLE sepolia.fct_data_column_availability_by_slot_blob_local
(
    ...
    PROJECTION p_by_slot_blob_column
    (
        SELECT *
        ORDER BY
            slot,
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/mainnet/fct_data_column_availability_by_slot_blob_local', '{replica}', updated_date_time)
PARTITION BY toStartOfMonth(slot_start_date_time)
ORDER BY (slot_start_date_time, blob_index, column_index)

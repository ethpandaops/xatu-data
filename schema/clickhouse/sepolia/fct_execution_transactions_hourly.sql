CREATE TABLE sepolia.fct_execution_transactions_hourly
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'fct_execution_transactions_hourly_local', cityHash64(hour_start_date_time))

CREATE TABLE sepolia.fct_validator_balance_hourly
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'fct_validator_balance_hourly_local', cityHash64(validator_index, hour_start_date_time))

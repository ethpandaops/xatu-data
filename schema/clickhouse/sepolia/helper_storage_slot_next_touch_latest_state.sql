CREATE TABLE sepolia.helper_storage_slot_next_touch_latest_state
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'helper_storage_slot_next_touch_latest_state_local', cityHash64(address, slot_key))

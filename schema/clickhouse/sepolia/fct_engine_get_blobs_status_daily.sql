CREATE TABLE sepolia.fct_engine_get_blobs_status_daily
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'fct_engine_get_blobs_status_daily_local', cityHash64(day_start_date, node_class))

CREATE TABLE sepolia.int_contract_storage_expiry_24m
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'int_contract_storage_expiry_24m_local', cityHash64(block_number, address))

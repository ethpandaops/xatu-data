CREATE TABLE sepolia.fct_attestation_correctness_canonical
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'fct_attestation_correctness_canonical_local', cityHash64(slot_start_date_time))

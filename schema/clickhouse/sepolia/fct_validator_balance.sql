CREATE TABLE sepolia.fct_validator_balance
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'fct_validator_balance_local', cityHash64(validator_index, epoch_start_date_time))

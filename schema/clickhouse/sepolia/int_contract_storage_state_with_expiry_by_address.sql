CREATE TABLE sepolia.int_contract_storage_state_with_expiry_by_address
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'int_contract_storage_state_with_expiry_by_address_local', cityHash64(address, block_number))

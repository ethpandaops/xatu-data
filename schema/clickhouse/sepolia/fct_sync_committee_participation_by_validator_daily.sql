CREATE TABLE sepolia.fct_sync_committee_participation_by_validator_daily
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'fct_sync_committee_participation_by_validator_daily_local', cityHash64(validator_index, day_start_date))

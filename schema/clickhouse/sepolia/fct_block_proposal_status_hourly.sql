CREATE TABLE sepolia.fct_block_proposal_status_hourly
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'fct_block_proposal_status_hourly_local', cityHash64(hour_start_date_time))

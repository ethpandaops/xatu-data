CREATE TABLE sepolia.int_engine_new_payload_fastest_execution_by_node_class
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'int_engine_new_payload_fastest_execution_by_node_class_local', cityHash64(slot_start_date_time, slot, node_class))

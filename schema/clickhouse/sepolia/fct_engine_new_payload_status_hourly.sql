CREATE TABLE sepolia.fct_engine_new_payload_status_hourly
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'fct_engine_new_payload_status_hourly_local', cityHash64(hour_start_date_time, node_class))

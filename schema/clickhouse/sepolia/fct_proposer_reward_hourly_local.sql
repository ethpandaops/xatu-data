CREATE TABLE sepolia.fct_proposer_reward_hourly_local
(
    ...
    `moving_avg_reward_eth` Float64 COMMENT 'Moving average proposer reward (6-hour window)' CODEC(ZSTD(1))
)
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/mainnet/fct_proposer_reward_hourly_local', '{replica}', updated_date_time)

CREATE TABLE sepolia.int_beacon_committee_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/mainnet/int_beacon_committee_local', '{replica}', updated_date_time)

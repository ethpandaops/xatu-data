CREATE TABLE sepolia.int_execution_state_size_by_block
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'int_execution_state_size_by_block_local', cityHash64(block_number))

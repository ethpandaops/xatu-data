CREATE TABLE sepolia.int_storage_slot_diff_by_address_slot
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'int_storage_slot_diff_by_address_slot_local', cityHash64(address, slot_key))

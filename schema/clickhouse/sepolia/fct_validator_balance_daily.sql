CREATE TABLE sepolia.fct_validator_balance_daily
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'fct_validator_balance_daily_local', cityHash64(validator_index, day_start_date))

CREATE TABLE sepolia.fct_storage_slot_state_by_address_daily
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'fct_storage_slot_state_by_address_daily_local', cityHash64(address, day_start_date))

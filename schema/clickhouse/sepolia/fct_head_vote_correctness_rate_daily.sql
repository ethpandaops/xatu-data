CREATE TABLE sepolia.fct_head_vote_correctness_rate_daily
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'fct_head_vote_correctness_rate_daily_local', cityHash64(day_start_date))

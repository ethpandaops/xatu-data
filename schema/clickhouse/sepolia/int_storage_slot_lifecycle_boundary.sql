CREATE TABLE sepolia.int_storage_slot_lifecycle_boundary
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'int_storage_slot_lifecycle_boundary_local', cityHash64(address, slot_key))

CREATE TABLE sepolia.int_contract_storage_reactivation_6m
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'int_contract_storage_reactivation_6m_local', cityHash64(block_number, address))

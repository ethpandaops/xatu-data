CREATE TABLE sepolia.int_execution_state_size_by_block_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/mainnet/int_execution_state_size_by_block_local', '{replica}', updated_date_time)

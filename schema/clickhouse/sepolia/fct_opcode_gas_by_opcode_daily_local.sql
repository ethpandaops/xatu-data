CREATE TABLE sepolia.fct_opcode_gas_by_opcode_daily_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/mainnet/fct_opcode_gas_by_opcode_daily_local', '{replica}', updated_date_time)

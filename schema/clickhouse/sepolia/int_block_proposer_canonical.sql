CREATE TABLE sepolia.int_block_proposer_canonical
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'int_block_proposer_canonical_local', cityHash64(slot_start_date_time))

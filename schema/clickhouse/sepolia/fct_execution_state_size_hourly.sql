CREATE TABLE sepolia.fct_execution_state_size_hourly
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'fct_execution_state_size_hourly_local', cityHash64(hour_start_date_time))

CREATE TABLE sepolia.fct_block_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/mainnet/fct_block_local', '{replica}', updated_date_time)

CREATE TABLE sepolia.int_address_storage_slot_first_access
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'int_address_storage_slot_first_access_local', cityHash64(address, slot_key))

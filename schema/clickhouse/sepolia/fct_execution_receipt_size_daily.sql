CREATE TABLE sepolia.fct_execution_receipt_size_daily
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'fct_execution_receipt_size_daily_local', cityHash64(day_start_date))

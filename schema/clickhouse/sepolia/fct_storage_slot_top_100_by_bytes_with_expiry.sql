CREATE TABLE sepolia.fct_storage_slot_top_100_by_bytes_with_expiry
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'fct_storage_slot_top_100_by_bytes_with_expiry_local', cityHash64(expiry_policy, rank))

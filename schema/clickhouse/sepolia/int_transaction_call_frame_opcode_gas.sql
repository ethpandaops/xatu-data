CREATE TABLE sepolia.int_transaction_call_frame_opcode_gas
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'int_transaction_call_frame_opcode_gas_local', cityHash64(block_number))

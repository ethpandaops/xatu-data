CREATE TABLE sepolia.fct_sync_committee_participation_by_validator_hourly
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'fct_sync_committee_participation_by_validator_hourly_local', cityHash64(validator_index, hour_start_date_time))

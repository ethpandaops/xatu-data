CREATE TABLE sepolia.int_storage_slot_reactivation_18m
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'int_storage_slot_reactivation_18m_local', cityHash64(block_number, address))

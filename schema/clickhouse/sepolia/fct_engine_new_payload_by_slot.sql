CREATE TABLE sepolia.fct_engine_new_payload_by_slot
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'fct_engine_new_payload_by_slot_local', cityHash64(slot_start_date_time, block_hash, status, node_class))

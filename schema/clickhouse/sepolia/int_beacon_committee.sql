CREATE TABLE sepolia.int_beacon_committee
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'int_beacon_committee_local', cityHash64(slot_start_date_time, committee_index))

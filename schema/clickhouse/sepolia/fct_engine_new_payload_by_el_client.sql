CREATE TABLE sepolia.fct_engine_new_payload_by_el_client
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'fct_engine_new_payload_by_el_client_local', cityHash64(slot_start_date_time, block_hash, meta_execution_implementation, meta_execution_version, status, node_class))

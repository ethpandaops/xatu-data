CREATE TABLE sepolia.fct_block_data_column_sidecar_first_seen_by_node
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'fct_block_data_column_sidecar_first_seen_by_node_local', cityHash64(slot_start_date_time, meta_client_name))

CREATE TABLE sepolia.int_transaction_call_frame
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'int_transaction_call_frame_local', cityHash64(block_number, transaction_hash))

CREATE TABLE sepolia.fct_engine_new_payload_status_hourly_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/mainnet/fct_engine_new_payload_status_hourly_local', '{replica}', updated_date_time)

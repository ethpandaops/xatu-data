CREATE TABLE sepolia.int_contract_storage_state_by_address_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/mainnet/int_contract_storage_state_by_address_local', '{replica}', updated_date_time)

CREATE TABLE sepolia.fct_block_proposer_by_validator
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'fct_block_proposer_by_validator_local', cityHash64(validator_index, slot_start_date_time))

CREATE TABLE sepolia.int_storage_slot_state_by_address
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'int_storage_slot_state_by_address_local', cityHash64(address, block_number))

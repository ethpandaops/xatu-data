CREATE TABLE sepolia.int_contract_storage_state_by_block
(
...
ENGINE = Distributed('{cluster}', 'sepolia', 'int_contract_storage_state_by_block_local', cityHash64(block_number))

CREATE TABLE default.canonical_execution_erc20_transfers_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/default/tables/canonical_execution_erc20_transfers_local/{shard}', '{replica}', updated_date_time)

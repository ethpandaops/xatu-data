CREATE TABLE default.canonical_beacon_block_attester_slashing_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/default/canonical_beacon_block_attester_slashing_local', '{replica}', updated_date_time)

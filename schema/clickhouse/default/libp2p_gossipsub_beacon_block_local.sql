CREATE TABLE default.libp2p_gossipsub_beacon_block_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/default/libp2p_gossipsub_beacon_block_local', '{replica}', updated_date_time)

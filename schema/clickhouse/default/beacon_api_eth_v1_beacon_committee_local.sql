...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/default/beacon_api_eth_v1_beacon_committee_local', '{replica}', updated_date_time)

CREATE TABLE default.beacon_api_eth_v1_validator_attestation_data_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/default/tables/beacon_api_eth_v1_validator_attestation_data_local/{shard}', '{replica}', updated_date_time)
PARTITION BY toStartOfMonth(slot_start_date_time)
ORDER BY (slot_start_date_time, meta_network_name, meta_client_name, committee_index, beacon_block_root, source_root, target_root)

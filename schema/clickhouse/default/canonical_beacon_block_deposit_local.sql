...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/default/tables/canonical_beacon_block_deposit_local/{shard}', '{replica}', updated_date_time)

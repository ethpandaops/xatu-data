CREATE TABLE default.libp2p_rpc_meta_control_ihave_local
(
    `unique_key` Int64,
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/default/libp2p_rpc_meta_control_ihave_local', '{replica}', updated_date_time)

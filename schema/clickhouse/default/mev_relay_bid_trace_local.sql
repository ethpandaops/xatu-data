CREATE TABLE default.mev_relay_bid_trace_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/default/mev_relay_bid_trace_local', '{replica}', updated_date_time)

CREATE TABLE default.libp2p_gossipsub_data_column_sidecar_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/default/tables/libp2p_gossipsub_data_column_sidecar_local/{shard}', '{replica}', updated_date_time)

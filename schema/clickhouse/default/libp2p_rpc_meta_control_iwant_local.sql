CREATE TABLE default.libp2p_rpc_meta_control_iwant_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/default/libp2p_rpc_meta_control_iwant_local', '{replica}', updated_date_time)

CREATE TABLE default.libp2p_rpc_meta_message_local
(
    `unique_key` Int64,
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/default/libp2p_rpc_meta_message_local', '{replica}', updated_date_time)

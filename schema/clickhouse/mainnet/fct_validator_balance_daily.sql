CREATE TABLE mainnet.fct_validator_balance_daily
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'fct_validator_balance_daily_local', cityHash64(validator_index, day_start_date))

CREATE TABLE mainnet.fct_data_column_availability_daily
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'fct_data_column_availability_daily_local', cityHash64(date, column_index))

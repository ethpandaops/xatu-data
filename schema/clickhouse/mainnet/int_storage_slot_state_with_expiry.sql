CREATE TABLE mainnet.int_storage_slot_state_with_expiry
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'int_storage_slot_state_with_expiry_local', cityHash64(block_number, address))

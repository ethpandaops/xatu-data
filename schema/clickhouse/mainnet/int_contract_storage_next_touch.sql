CREATE TABLE mainnet.int_contract_storage_next_touch
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'int_contract_storage_next_touch_local', cityHash64(block_number, address))

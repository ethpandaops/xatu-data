CREATE TABLE mainnet.fct_head_vote_correctness_rate_hourly
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'fct_head_vote_correctness_rate_hourly_local', cityHash64(hour_start_date_time))

CREATE TABLE mainnet.fct_block_blob_head
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'fct_block_blob_head_local', cityHash64(slot_start_date_time, block_root, blob_index))

CREATE TABLE mainnet.fct_mev_bid_count_by_builder
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'fct_mev_bid_count_by_builder_local', cityHash64(slot_start_date_time, builder_pubkey))

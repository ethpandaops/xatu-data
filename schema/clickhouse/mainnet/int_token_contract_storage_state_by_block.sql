CREATE TABLE mainnet.int_token_contract_storage_state_by_block
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'int_token_contract_storage_state_by_block_local', cityHash64(block_number))

CREATE TABLE mainnet.int_storage_slot_reactivation_1m
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'int_storage_slot_reactivation_1m_local', cityHash64(block_number, address))

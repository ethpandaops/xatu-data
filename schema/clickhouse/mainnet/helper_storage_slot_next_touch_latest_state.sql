CREATE TABLE mainnet.helper_storage_slot_next_touch_latest_state
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'helper_storage_slot_next_touch_latest_state_local', cityHash64(address, slot_key))

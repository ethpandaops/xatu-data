CREATE TABLE mainnet.fct_sync_committee_participation_by_validator
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'fct_sync_committee_participation_by_validator_local', cityHash64(validator_index, slot_start_date_time))

CREATE TABLE mainnet.fct_block_data_column_sidecar_first_seen_by_node
(
    ...
    `row_count` UInt32 COMMENT 'The number of rows (blobs) in the data column sidecar',
...
ENGINE = Distributed('{cluster}', 'mainnet', 'fct_block_data_column_sidecar_first_seen_by_node_local', cityHash64(slot_start_date_time, meta_client_name))

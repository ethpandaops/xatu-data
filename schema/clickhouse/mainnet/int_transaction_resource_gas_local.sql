CREATE TABLE mainnet.int_transaction_resource_gas_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/mainnet/int_transaction_resource_gas_local', '{replica}', updated_date_time)

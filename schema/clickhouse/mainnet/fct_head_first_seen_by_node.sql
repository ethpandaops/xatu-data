CREATE TABLE mainnet.fct_head_first_seen_by_node
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'fct_head_first_seen_by_node_local', cityHash64(slot_start_date_time, meta_client_name))

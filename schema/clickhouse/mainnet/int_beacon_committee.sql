CREATE TABLE mainnet.int_beacon_committee
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'int_beacon_committee_local', cityHash64(slot_start_date_time, committee_index))

CREATE TABLE mainnet.fct_engine_get_blobs_duration_chunked_50ms
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'fct_engine_get_blobs_duration_chunked_50ms_local', cityHash64(slot_start_date_time, block_root, node_class, chunk_duration_ms))

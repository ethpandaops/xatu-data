CREATE TABLE mainnet.fct_block_proposal_status_daily
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'fct_block_proposal_status_daily_local', cityHash64(day_start_date))

CREATE TABLE mainnet.fct_storage_slot_state_with_expiry_daily
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'fct_storage_slot_state_with_expiry_daily_local', cityHash64(expiry_policy, day_start_date))

CREATE TABLE mainnet.fct_storage_slot_state_by_block_daily
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'fct_storage_slot_state_by_block_daily_local', cityHash64(day_start_date))

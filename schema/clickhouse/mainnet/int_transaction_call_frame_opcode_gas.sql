CREATE TABLE mainnet.int_transaction_call_frame_opcode_gas
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'int_transaction_call_frame_opcode_gas_local', cityHash64(block_number, transaction_hash))

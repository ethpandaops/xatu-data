CREATE TABLE mainnet.fct_validator_count_by_entity_by_status_daily
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'fct_validator_count_by_entity_by_status_daily_local', cityHash64(day_start_date, entity))

CREATE TABLE mainnet.fct_attestation_correctness_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/mainnet/fct_attestation_correctness_local', '{replica}', updated_date_time)

CREATE TABLE mainnet.fct_execution_gas_used_daily_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/mainnet/fct_execution_gas_used_daily_local', '{replica}', updated_date_time)

CREATE TABLE mainnet.fct_block_proposer_head
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'fct_block_proposer_head_local', cityHash64(slot_start_date_time, proposer_validator_index))

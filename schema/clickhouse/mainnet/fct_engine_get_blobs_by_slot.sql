CREATE TABLE mainnet.fct_engine_get_blobs_by_slot
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'fct_engine_get_blobs_by_slot_local', cityHash64(slot_start_date_time, block_root, status, node_class))

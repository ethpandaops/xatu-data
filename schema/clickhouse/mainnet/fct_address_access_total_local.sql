CREATE TABLE mainnet.fct_address_access_total_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/mainnet/fct_address_access_total_local', '{replica}', updated_date_time)
PARTITION BY tuple()

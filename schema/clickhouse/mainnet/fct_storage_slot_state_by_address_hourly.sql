CREATE TABLE mainnet.fct_storage_slot_state_by_address_hourly
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'fct_storage_slot_state_by_address_hourly_local', cityHash64(address, hour_start_date_time))

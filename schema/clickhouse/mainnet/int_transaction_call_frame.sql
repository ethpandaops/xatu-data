CREATE TABLE mainnet.int_transaction_call_frame
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'int_transaction_call_frame_local', cityHash64(block_number, transaction_hash))

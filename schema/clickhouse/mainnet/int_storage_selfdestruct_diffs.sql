CREATE TABLE mainnet.int_storage_selfdestruct_diffs
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'int_storage_selfdestruct_diffs_local', cityHash64(block_number, address))

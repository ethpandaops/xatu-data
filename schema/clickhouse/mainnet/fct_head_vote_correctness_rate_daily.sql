CREATE TABLE mainnet.fct_head_vote_correctness_rate_daily
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'fct_head_vote_correctness_rate_daily_local', cityHash64(day_start_date))

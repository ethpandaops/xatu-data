CREATE TABLE mainnet.fct_engine_new_payload_status_daily_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/mainnet/fct_engine_new_payload_status_daily_local', '{replica}', updated_date_time)
PARTITION BY toYYYYMM(day_start_date)
ORDER BY (day_start_date, node_class)

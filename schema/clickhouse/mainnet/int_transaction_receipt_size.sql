CREATE TABLE mainnet.int_transaction_receipt_size
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'int_transaction_receipt_size_local', cityHash64(block_number, transaction_hash))

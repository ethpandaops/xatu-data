CREATE TABLE mainnet.fct_attestation_correctness_head
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'fct_attestation_correctness_head_local', cityHash64(slot_start_date_time))

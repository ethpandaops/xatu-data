CREATE TABLE mainnet.int_custody_probe_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/mainnet/int_custody_probe_local', '{replica}', updated_date_time)
PARTITION BY toYYYYMM(probe_date_time)
ORDER BY (probe_date_time, slot, peer_id_unique_key, result, error)

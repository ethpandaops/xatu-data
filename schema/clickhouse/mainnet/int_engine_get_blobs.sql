CREATE TABLE mainnet.int_engine_get_blobs
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'int_engine_get_blobs_local', cityHash64(slot_start_date_time, block_root, meta_client_name, event_date_time))

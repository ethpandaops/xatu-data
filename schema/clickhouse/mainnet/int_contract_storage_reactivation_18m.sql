CREATE TABLE mainnet.int_contract_storage_reactivation_18m
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'int_contract_storage_reactivation_18m_local', cityHash64(block_number, address))

CREATE TABLE mainnet.fct_engine_get_blobs_by_el_client
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'fct_engine_get_blobs_by_el_client_local', cityHash64(slot_start_date_time, block_root, meta_execution_implementation, meta_execution_version, status, node_class))

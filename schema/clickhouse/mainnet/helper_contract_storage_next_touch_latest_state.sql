CREATE TABLE mainnet.helper_contract_storage_next_touch_latest_state
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'helper_contract_storage_next_touch_latest_state_local', cityHash64(address))

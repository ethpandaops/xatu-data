CREATE TABLE mainnet.int_storage_slot_lifecycle_boundary
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'int_storage_slot_lifecycle_boundary_local', cityHash64(address, slot_key))

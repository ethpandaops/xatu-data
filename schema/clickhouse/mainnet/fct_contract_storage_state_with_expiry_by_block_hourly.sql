CREATE TABLE mainnet.fct_contract_storage_state_with_expiry_by_block_hourly
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'fct_contract_storage_state_with_expiry_by_block_hourly_local', cityHash64(expiry_policy, hour_start_date_time))

CREATE TABLE mainnet.fct_engine_get_blobs_status_hourly
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'fct_engine_get_blobs_status_hourly_local', cityHash64(hour_start_date_time, node_class))

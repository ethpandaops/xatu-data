CREATE TABLE mainnet.int_attestation_attested_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/mainnet/int_attestation_attested_local', '{replica}', updated_date_time)

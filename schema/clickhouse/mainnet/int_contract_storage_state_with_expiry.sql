CREATE TABLE mainnet.int_contract_storage_state_with_expiry
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'int_contract_storage_state_with_expiry_local', cityHash64(block_number, address))

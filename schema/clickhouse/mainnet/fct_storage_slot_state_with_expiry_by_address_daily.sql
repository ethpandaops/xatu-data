CREATE TABLE mainnet.fct_storage_slot_state_with_expiry_by_address_daily
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'fct_storage_slot_state_with_expiry_by_address_daily_local', cityHash64(address, expiry_policy, day_start_date))

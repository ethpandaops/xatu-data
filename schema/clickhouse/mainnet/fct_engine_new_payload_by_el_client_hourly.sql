CREATE TABLE mainnet.fct_engine_new_payload_by_el_client_hourly
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'fct_engine_new_payload_by_el_client_hourly_local', cityHash64(hour_start_date_time, meta_execution_implementation, meta_execution_version, node_class))

CREATE TABLE mainnet.fct_data_column_availability_by_epoch
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'fct_data_column_availability_by_epoch_local', cityHash64(epoch_start_date_time, column_index))

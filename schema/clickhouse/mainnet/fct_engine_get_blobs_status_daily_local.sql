CREATE TABLE mainnet.fct_engine_get_blobs_status_daily_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/mainnet/fct_engine_get_blobs_status_daily_local', '{replica}', updated_date_time)

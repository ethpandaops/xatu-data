CREATE TABLE mainnet.int_execution_state_size_by_block
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'int_execution_state_size_by_block_local', cityHash64(block_number))

CREATE TABLE mainnet.int_contract_storage_state_by_address
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'int_contract_storage_state_by_address_local', cityHash64(address, block_number))

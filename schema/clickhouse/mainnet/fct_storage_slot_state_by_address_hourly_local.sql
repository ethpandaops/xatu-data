CREATE TABLE mainnet.fct_storage_slot_state_by_address_hourly_local
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/{installation}/{cluster}/tables/{shard}/mainnet/fct_storage_slot_state_by_address_hourly_local', '{replica}', updated_date_time)

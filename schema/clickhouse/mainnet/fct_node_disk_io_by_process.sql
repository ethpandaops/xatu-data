CREATE TABLE mainnet.fct_node_disk_io_by_process
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'fct_node_disk_io_by_process_local', cityHash64(wallclock_slot_start_date_time, meta_client_name))

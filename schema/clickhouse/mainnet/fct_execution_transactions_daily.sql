CREATE TABLE mainnet.fct_execution_transactions_daily
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'fct_execution_transactions_daily_local', cityHash64(day_start_date))

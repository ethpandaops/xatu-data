CREATE TABLE mainnet.int_contract_storage_expiry_24m
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'int_contract_storage_expiry_24m_local', cityHash64(block_number, address))

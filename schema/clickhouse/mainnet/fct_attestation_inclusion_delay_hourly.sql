CREATE TABLE mainnet.fct_attestation_inclusion_delay_hourly
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'fct_attestation_inclusion_delay_hourly_local', cityHash64(hour_start_date_time))

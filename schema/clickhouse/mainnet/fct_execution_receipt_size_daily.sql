CREATE TABLE mainnet.fct_execution_receipt_size_daily
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'fct_execution_receipt_size_daily_local', cityHash64(day_start_date))

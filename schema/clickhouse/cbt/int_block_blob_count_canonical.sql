CREATE TABLE mainnet.int_block_blob_count_canonical
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'int_block_blob_count_canonical_local', cityHash64(slot_start_date_time, block_root))

CREATE TABLE mainnet.int_beacon_committee_head
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'int_beacon_committee_head_local', cityHash64(slot_start_date_time, committee_index))

CREATE TABLE mainnet.fct_attestation_first_seen_chunked_50ms
(
...
ENGINE = Distributed('{cluster}', 'mainnet', 'fct_attestation_first_seen_chunked_50ms_local', cityHash64(slot_start_date_time, block_root))

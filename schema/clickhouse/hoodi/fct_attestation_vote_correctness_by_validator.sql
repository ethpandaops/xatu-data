CREATE TABLE hoodi.fct_attestation_vote_correctness_by_validator
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'fct_attestation_vote_correctness_by_validator_local', cityHash64(validator_index, slot_start_date_time))

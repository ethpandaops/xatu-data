CREATE TABLE hoodi.fct_block_blob_count_head
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'fct_block_blob_count_head_local', cityHash64(slot_start_date_time, block_root))

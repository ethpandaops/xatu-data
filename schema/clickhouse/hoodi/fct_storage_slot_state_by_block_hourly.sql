CREATE TABLE hoodi.fct_storage_slot_state_by_block_hourly
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'fct_storage_slot_state_by_block_hourly_local', cityHash64(hour_start_date_time))

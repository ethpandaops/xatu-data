CREATE TABLE hoodi.int_contract_storage_expiry_1m
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'int_contract_storage_expiry_1m_local', cityHash64(block_number, address))

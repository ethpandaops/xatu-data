CREATE TABLE hoodi.fct_data_column_availability_daily
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'fct_data_column_availability_daily_local', cityHash64(date, column_index))

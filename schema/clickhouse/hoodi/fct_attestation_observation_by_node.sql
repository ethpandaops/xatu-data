CREATE TABLE hoodi.fct_attestation_observation_by_node
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'fct_attestation_observation_by_node_local', cityHash64(slot_start_date_time, meta_client_name))

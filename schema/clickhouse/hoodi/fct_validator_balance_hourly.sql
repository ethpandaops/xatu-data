CREATE TABLE hoodi.fct_validator_balance_hourly
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'fct_validator_balance_hourly_local', cityHash64(validator_index, hour_start_date_time))

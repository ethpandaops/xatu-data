CREATE TABLE hoodi.fct_engine_new_payload_winrate_daily
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'fct_engine_new_payload_winrate_daily_local', cityHash64(day_start_date, node_class))

CREATE TABLE hoodi.fct_contract_storage_state_with_expiry_by_address_daily
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'fct_contract_storage_state_with_expiry_by_address_daily_local', cityHash64(address, expiry_policy, day_start_date))

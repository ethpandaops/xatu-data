CREATE TABLE hoodi.int_transaction_call_frame
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'int_transaction_call_frame_local', cityHash64(block_number, transaction_hash))

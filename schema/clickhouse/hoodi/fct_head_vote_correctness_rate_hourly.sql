CREATE TABLE hoodi.fct_head_vote_correctness_rate_hourly
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'fct_head_vote_correctness_rate_hourly_local', cityHash64(hour_start_date_time))

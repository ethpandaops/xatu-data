CREATE TABLE hoodi.fct_data_column_availability_by_epoch
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'fct_data_column_availability_by_epoch_local', cityHash64(epoch_start_date_time, column_index))

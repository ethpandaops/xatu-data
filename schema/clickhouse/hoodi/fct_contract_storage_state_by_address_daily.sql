CREATE TABLE hoodi.fct_contract_storage_state_by_address_daily
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'fct_contract_storage_state_by_address_daily_local', cityHash64(address, day_start_date))

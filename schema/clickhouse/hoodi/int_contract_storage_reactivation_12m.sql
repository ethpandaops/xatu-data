CREATE TABLE hoodi.int_contract_storage_reactivation_12m
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'int_contract_storage_reactivation_12m_local', cityHash64(block_number, address))

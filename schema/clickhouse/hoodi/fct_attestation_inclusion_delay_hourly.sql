CREATE TABLE hoodi.fct_attestation_inclusion_delay_hourly
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'fct_attestation_inclusion_delay_hourly_local', cityHash64(hour_start_date_time))

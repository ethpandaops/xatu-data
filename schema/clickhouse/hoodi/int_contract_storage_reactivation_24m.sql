CREATE TABLE hoodi.int_contract_storage_reactivation_24m
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'int_contract_storage_reactivation_24m_local', cityHash64(block_number, address))

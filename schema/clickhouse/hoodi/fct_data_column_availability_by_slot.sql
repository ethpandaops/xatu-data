CREATE TABLE hoodi.fct_data_column_availability_by_slot
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'fct_data_column_availability_by_slot_local', cityHash64(slot_start_date_time, column_index))

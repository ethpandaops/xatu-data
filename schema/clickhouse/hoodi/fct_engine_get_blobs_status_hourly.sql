CREATE TABLE hoodi.fct_engine_get_blobs_status_hourly
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'fct_engine_get_blobs_status_hourly_local', cityHash64(hour_start_date_time, node_class))

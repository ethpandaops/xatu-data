CREATE TABLE hoodi.fct_attestation_liveness_by_entity_head
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'fct_attestation_liveness_by_entity_head_local', cityHash64(slot))

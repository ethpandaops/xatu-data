CREATE TABLE hoodi.fct_node_cpu_utilization_by_process
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'fct_node_cpu_utilization_by_process_local', cityHash64(wallclock_slot_start_date_time, meta_client_name))

CREATE TABLE hoodi.int_custody_probe_order_by_slot
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'int_custody_probe_order_by_slot_local', cityHash64(slot_start_date_time, slot, peer_id_unique_key))

CREATE TABLE hoodi.fct_contract_storage_state_by_address_hourly
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'fct_contract_storage_state_by_address_hourly_local', cityHash64(address, hour_start_date_time))

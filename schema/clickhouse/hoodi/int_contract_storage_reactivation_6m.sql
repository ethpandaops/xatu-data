CREATE TABLE hoodi.int_contract_storage_reactivation_6m
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'int_contract_storage_reactivation_6m_local', cityHash64(block_number, address))

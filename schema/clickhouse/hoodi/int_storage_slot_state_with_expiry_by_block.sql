CREATE TABLE hoodi.int_storage_slot_state_with_expiry_by_block
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'int_storage_slot_state_with_expiry_by_block_local', cityHash64(block_number))

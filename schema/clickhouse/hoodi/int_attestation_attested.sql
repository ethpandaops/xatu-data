CREATE TABLE hoodi.int_attestation_attested
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'int_attestation_attested_local', cityHash64(slot_start_date_time, block_root, attesting_validator_index))

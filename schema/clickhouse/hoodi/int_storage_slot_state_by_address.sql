CREATE TABLE hoodi.int_storage_slot_state_by_address
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'int_storage_slot_state_by_address_local', cityHash64(address, block_number))

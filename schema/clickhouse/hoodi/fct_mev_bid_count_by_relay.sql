CREATE TABLE hoodi.fct_mev_bid_count_by_relay
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'fct_mev_bid_count_by_relay_local', cityHash64(slot_start_date_time, relay_name))

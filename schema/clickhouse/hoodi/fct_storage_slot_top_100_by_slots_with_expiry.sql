CREATE TABLE hoodi.fct_storage_slot_top_100_by_slots_with_expiry
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'fct_storage_slot_top_100_by_slots_with_expiry_local', cityHash64(expiry_policy, rank))

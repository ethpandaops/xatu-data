CREATE TABLE hoodi.fct_block_proposal_status_hourly
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'fct_block_proposal_status_hourly_local', cityHash64(hour_start_date_time))

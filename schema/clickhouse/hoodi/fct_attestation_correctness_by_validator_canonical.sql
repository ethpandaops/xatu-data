CREATE TABLE hoodi.fct_attestation_correctness_by_validator_canonical
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'fct_attestation_correctness_by_validator_canonical_local', cityHash64(slot_start_date_time, attesting_validator_index))

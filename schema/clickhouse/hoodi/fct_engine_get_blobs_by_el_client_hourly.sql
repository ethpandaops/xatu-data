CREATE TABLE hoodi.fct_engine_get_blobs_by_el_client_hourly
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'fct_engine_get_blobs_by_el_client_hourly_local', cityHash64(hour_start_date_time, meta_execution_implementation, meta_execution_version, node_class))

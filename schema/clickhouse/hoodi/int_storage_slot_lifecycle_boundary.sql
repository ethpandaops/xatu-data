CREATE TABLE hoodi.int_storage_slot_lifecycle_boundary
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'int_storage_slot_lifecycle_boundary_local', cityHash64(address, slot_key))

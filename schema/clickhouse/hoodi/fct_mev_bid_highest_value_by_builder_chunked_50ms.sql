CREATE TABLE hoodi.fct_mev_bid_highest_value_by_builder_chunked_50ms
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'fct_mev_bid_highest_value_by_builder_chunked_50ms_local', cityHash64(slot_start_date_time, chunk_slot_start_diff, builder_pubkey))

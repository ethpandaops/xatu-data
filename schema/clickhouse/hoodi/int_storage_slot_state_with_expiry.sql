CREATE TABLE hoodi.int_storage_slot_state_with_expiry
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'int_storage_slot_state_with_expiry_local', cityHash64(block_number, address))

CREATE TABLE hoodi.fct_storage_slot_state_with_expiry
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'fct_storage_slot_state_with_expiry_local', cityHash64(block_number))

CREATE TABLE hoodi.int_transaction_resource_gas
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'int_transaction_resource_gas_local', cityHash64(block_number, transaction_hash))

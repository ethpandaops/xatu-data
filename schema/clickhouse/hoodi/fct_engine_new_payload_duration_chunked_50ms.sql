CREATE TABLE hoodi.fct_engine_new_payload_duration_chunked_50ms
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'fct_engine_new_payload_duration_chunked_50ms_local', cityHash64(slot_start_date_time, block_hash, node_class, chunk_duration_ms))

CREATE TABLE hoodi.int_token_contract_storage_state_by_block
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'int_token_contract_storage_state_by_block_local', cityHash64(block_number))

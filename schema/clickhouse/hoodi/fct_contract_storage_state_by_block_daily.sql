CREATE TABLE hoodi.fct_contract_storage_state_by_block_daily
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'fct_contract_storage_state_by_block_daily_local', cityHash64(day_start_date))

CREATE TABLE hoodi.int_contract_storage_expiry_6m
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'int_contract_storage_expiry_6m_local', cityHash64(block_number, address))

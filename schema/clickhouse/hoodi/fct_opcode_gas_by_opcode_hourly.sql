CREATE TABLE hoodi.fct_opcode_gas_by_opcode_hourly
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'fct_opcode_gas_by_opcode_hourly_local', cityHash64(hour_start_date_time))

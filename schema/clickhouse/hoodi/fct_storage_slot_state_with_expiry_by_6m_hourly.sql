CREATE TABLE hoodi.fct_storage_slot_state_with_expiry_by_6m_hourly
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'fct_storage_slot_state_with_expiry_by_6m_hourly_local', cityHash64(hour_start_date_time))

CREATE TABLE hoodi.int_storage_slot_reactivation_6m
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'int_storage_slot_reactivation_6m_local', cityHash64(block_number, address))

CREATE TABLE hoodi.int_address_storage_slot_last_access
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'int_address_storage_slot_last_access_local', cityHash64(address, slot_key))

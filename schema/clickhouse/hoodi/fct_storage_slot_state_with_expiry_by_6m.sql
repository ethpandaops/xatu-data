CREATE TABLE hoodi.fct_storage_slot_state_with_expiry_by_6m
(
...
ENGINE = Distributed('{cluster}', 'hoodi', 'fct_storage_slot_state_with_expiry_by_6m_local', cityHash64(block_number))

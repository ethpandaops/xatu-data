...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/mev_relay_bid_trace/2025/4/29.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
2025-05-06 18:04:16 - Local table SQL DDL saved to ./schema/clickhouse/default/mev_relay_bid_trace_local.sql
2025-05-06 18:04:16 - Distributed table SQL DDL saved to ./schema/clickhouse/default/mev_relay_bid_trace.sql
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/mev_relay_proposer_payload_delivered/2025/4/29.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
2025-05-06 18:04:16 - Local table SQL DDL saved to ./schema/clickhouse/default/mev_relay_proposer_payload_delivered_local.sql
2025-05-06 18:04:16 - Distributed table SQL DDL saved to ./schema/clickhouse/default/mev_relay_proposer_payload_delivered.sql
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/mev_relay_validator_registration/2025/4/29.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
2025-05-06 18:04:17 - Local table SQL DDL saved to ./schema/clickhouse/default/mev_relay_validator_registration_local.sql
2025-05-06 18:04:17 - Distributed table SQL DDL saved to ./schema/clickhouse/default/mev_relay_validator_registration.sql
<!-- schema_end -->

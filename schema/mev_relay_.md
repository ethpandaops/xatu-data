...
- **mainnet**: `2024-09-13` to `2025-05-14`
- **holesky**: `2024-09-13` to `2025-05-14`
- **sepolia**: `2024-09-13` to `2025-05-14`
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/mev_relay_bid_trace/2025/5/9.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
2025-05-16 06:03:55 - Local table SQL DDL saved to ./schema/clickhouse/default/mev_relay_bid_trace_local.sql
2025-05-16 06:03:55 - Distributed table SQL DDL saved to ./schema/clickhouse/default/mev_relay_bid_trace.sql
...
- **mainnet**: `2024-09-16` to `2025-05-14`
- **holesky**: `2024-09-16` to `2025-05-14`
- **sepolia**: `2024-09-16` to `2025-05-14`
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/mev_relay_proposer_payload_delivered/2025/5/9.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
2025-05-16 06:03:55 - Local table SQL DDL saved to ./schema/clickhouse/default/mev_relay_proposer_payload_delivered_local.sql
2025-05-16 06:03:55 - Distributed table SQL DDL saved to ./schema/clickhouse/default/mev_relay_proposer_payload_delivered.sql
...
- **mainnet**: `2024-12-11` to `2025-05-14`
- **holesky**: `2024-12-11` to `2025-04-27`
- **sepolia**: `2024-12-11` to `2025-05-14`
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/mev_relay_validator_registration/2025/5/9.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
2025-05-16 06:03:55 - Local table SQL DDL saved to ./schema/clickhouse/default/mev_relay_validator_registration_local.sql
2025-05-16 06:03:55 - Distributed table SQL DDL saved to ./schema/clickhouse/default/mev_relay_validator_registration.sql
<!-- schema_end -->

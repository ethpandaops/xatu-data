...
- **mainnet**: `2024-09-13` to `2026-07-22`
- **holesky**: `2024-09-13` to `2025-10-26`
- **sepolia**: `2024-09-13` to `2026-07-22`
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/mev_relay_bid_trace/2026/7/22.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
- **sepolia**: `2024-09-16` to `2026-07-22`
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/mev_relay_proposer_payload_delivered/2026/7/22.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```
...
- **mainnet**: `2024-12-11` to `2026-07-22`
- **holesky**: `2024-12-11` to `2025-04-27`
- **sepolia**: `2024-12-11` to `2026-07-22`
...
docker run --rm -it clickhouse/clickhouse-server clickhouse local --query --query="""
    SELECT
        *
    FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/mev_relay_validator_registration/2026/7/22.parquet', 'Parquet')
    LIMIT 10
    FORMAT Pretty
"""
```

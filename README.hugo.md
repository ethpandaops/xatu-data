...
- **mainnet**: `2023-09-05` to `2024-04-26`
- **holesky**: `2023-12-25` to `2024-04-26`
- **sepolia**: `2023-12-24` to `2024-04-26`
...
```bash
clickhouse client -q "SELECT * FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v1_beacon_committee/2024/4/21/0.parquet', 'Parquet') LIMIT 10"
```
...
- **mainnet**: `2023-06-05` to `2024-04-26`
- **holesky**: `2023-09-29` to `2024-04-25`
- **sepolia**: `2023-09-01` to `2024-04-25`
...
```bash
clickhouse client -q "SELECT * FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v1_events_attestation/2024/4/21/0.parquet', 'Parquet') LIMIT 10"
```
...
- **mainnet**: `2024-03-13` to `2024-04-25`
- **holesky**: `2024-02-07` to `2024-04-25`
- **sepolia**: `2024-01-30` to `2024-04-25`
...
```bash
clickhouse client -q "SELECT * FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v1_events_blob_sidecar/2024/4/21.parquet', 'Parquet') LIMIT 10"
```
...
- **mainnet**: `2023-02-28` to `2024-04-25`
- **holesky**: `2023-12-24` to `2024-04-25`
- **sepolia**: `2023-12-24` to `2024-04-25`
...
```bash
clickhouse client -q "SELECT * FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v1_events_block/2024/4/21.parquet', 'Parquet') LIMIT 10"
```
...
- **mainnet**: `2023-03-01` to `2024-04-25`
- **holesky**: `2024-02-05` to `2024-04-25`
- **sepolia**: `2024-04-25` to `2024-04-25`
...
```bash
clickhouse client -q "SELECT * FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v1_events_chain_reorg/2024/4/21.parquet', 'Parquet') LIMIT 10"
```
...
- **mainnet**: `2023-08-31` to `2024-04-25`
- **holesky**: `2023-12-24` to `2024-04-25`
- **sepolia**: `2023-12-24` to `2024-04-25`
...
```bash
clickhouse client -q "SELECT * FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v1_events_contribution_and_proof/2024/4/21.parquet', 'Parquet') LIMIT 10"
```
...
- **mainnet**: `2023-04-10` to `2024-04-25`
- **holesky**: `2023-03-26` to `2024-04-25`
- **sepolia**: `2023-03-26` to `2024-04-25`
...
```bash
clickhouse client -q "SELECT * FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v1_events_finalized_checkpoint/2024/4/21.parquet', 'Parquet') LIMIT 10"
```
...
- **mainnet**: `2023-08-30` to `2024-04-25`
- **holesky**: `2023-12-05` to `2024-04-25`
- **sepolia**: `2023-12-05` to `2024-04-25`
...
```bash
clickhouse client -q "SELECT * FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v1_events_head/2024/4/21.parquet', 'Parquet') LIMIT 10"
```
...
```bash
clickhouse client -q "SELECT * FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v1_events_voluntary_exit/2024/4/21.parquet', 'Parquet') LIMIT 10"
```
...
```bash
clickhouse client -q "SELECT * FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v1_validator_attestation_data/2024/4/21.parquet', 'Parquet') LIMIT 10"
```
...
- **mainnet**: `2023-11-14` to `2024-04-24`
- **holesky**: `2023-12-24` to `2024-04-24`
- **sepolia**: `2023-12-24` to `2024-04-24`
...
```bash
clickhouse client -q "SELECT * FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v2_beacon_block/2024/4/21.parquet', 'Parquet') LIMIT 10"
```
...
- **mainnet**: `2023-07-22` to `2024-04-26`
- **holesky**: `2024-01-08` to `2024-04-26`
- **sepolia**: `2024-01-08` to `2024-04-26`
...
```bash
clickhouse client -q "SELECT * FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/mempool_transaction/2024/4/21.parquet', 'Parquet') LIMIT 10"
```
...
- **mainnet**: `2024-04-03` to `2024-04-24`
- **holesky**: `2024-04-03` to `2024-04-24`
- **sepolia**: `2024-04-03` to `2024-04-24`
...
```bash
clickhouse client -q "SELECT * FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/beacon_api_eth_v1_proposer_duty/2024/4/21.parquet', 'Parquet') LIMIT 10"
```
...
- **mainnet**: `2020-12-01` to `2024-04-26`
- **holesky**: `2023-09-28` to `2024-04-26`
- **sepolia**: `2022-06-20` to `2024-04-26`
...
```bash
clickhouse client -q "SELECT * FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/canonical_beacon_block/2024/4/21.parquet', 'Parquet') LIMIT 10"
```
...
```bash
clickhouse client -q "SELECT * FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/canonical_beacon_block_attester_slashing/2024/4/21.parquet', 'Parquet') LIMIT 10"
```
...
```bash
clickhouse client -q "SELECT * FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/canonical_beacon_block_proposer_slashing/2024/4/21.parquet', 'Parquet') LIMIT 10"
```
...
- **mainnet**: `2023-04-12` to `2024-04-26`
- **holesky**: `2024-04-26` to `2024-04-26`
...
```bash
clickhouse client -q "SELECT * FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/canonical_beacon_block_bls_to_execution_change/2024/4/21.parquet', 'Parquet') LIMIT 10"
```
...
- **mainnet**: `2022-09-15` to `2024-04-26`
- **holesky**: `2023-09-28` to `2024-04-25`
- **sepolia**: `2022-07-06` to `2024-04-26`
...
```bash
clickhouse client -q "SELECT * FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/canonical_beacon_block_execution_transaction/2024/4/21.parquet', 'Parquet') LIMIT 10"
```
...
- **mainnet**: `2023-04-02` to `2024-04-25`
- **holesky**: `2024-02-11` to `2024-04-25`
...
```bash
clickhouse client -q "SELECT * FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/canonical_beacon_block_voluntary_exit/2024/4/21.parquet', 'Parquet') LIMIT 10"
```
...
- **mainnet**: `2020-12-01` to `2024-04-26`
- **holesky**: `2023-09-29` to `2024-04-26`
...
```bash
clickhouse client -q "SELECT * FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/canonical_beacon_block_deposit/2024/4/21.parquet', 'Parquet') LIMIT 10"
```
...
- **mainnet**: `2023-04-12` to `2024-04-25`
- **holesky**: `2023-09-29` to `2024-04-25`
- **sepolia**: `2023-02-28` to `2024-04-25`
...
```bash
clickhouse client -q "SELECT * FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/canonical_beacon_block_withdrawal/2024/4/21.parquet', 'Parquet') LIMIT 10"
```
...
- **mainnet**: `2024-03-13` to `2024-04-26`
- **holesky**: `2024-02-07` to `2024-04-26`
- **sepolia**: `2024-01-30` to `2024-04-26`
...
```bash
clickhouse client -q "SELECT * FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/canonical_beacon_blob_sidecar/2024/4/21.parquet', 'Parquet') LIMIT 10"
```
...
- **mainnet**: `2020-12-01` to `2024-04-25`
- **holesky**: `2023-09-28` to `2024-04-26`
- **sepolia**: `2022-06-20` to `2024-04-26`
...
```bash
clickhouse client -q "SELECT * FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/canonical_beacon_proposer_duty/2024/4/21.parquet', 'Parquet') LIMIT 10"
```
...
- **mainnet**: `2023-05-03` to `2024-04-25`
- **holesky**: `2023-09-28` to `2024-04-25`
- **sepolia**: `2023-04-05` to `2024-04-25`
...
```bash
clickhouse client -q "SELECT * FROM url('https://data.ethpandaops.io/xatu/mainnet/databases/default/canonical_beacon_elaborated_attestation/2024/4/21.parquet', 'Parquet') LIMIT 10"
```
